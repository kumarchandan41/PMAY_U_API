...
namespace WeeklyReportAPI.Controllers
{
    ...
    public class Admin_ValuesController : ApiController
    {
        ...
        public HttpResponseMessage SubmitStateData(State_Master obj)
        {
            using (EmployeeEntities ent = new EmployeeEntities())
            {
                if (ent.State_Master.Any(ac => ac.States_UT.Equals(obj.States_UT)))
                {
        ...
        public IEnumerable<Distt_Master> GetDistrictData(string id)
        {

            IEnumerable<Distt_Master> lst = new List<Distt_Master>();
            EmployeeEntities objEntity = new EmployeeEntities();
            objEntity.Configuration.ProxyCreationEnabled = false;
            lst = objEntity.Distt_Master.Where(x => x.StateCode == id).OrderBy(x => x.District).ToList();
            return lst;
        }
        ...
        public IEnumerable<Distt_Master> GetStateDistrictId([FromUri]string id)
        {

            IEnumerable<Distt_Master> lst = new List<Distt_Master>();
            EmployeeEntities objEntity = new EmployeeEntities();
            objEntity.Configuration.ProxyCreationEnabled = false;
            lst = objEntity.Distt_Master.Where(x => x.StateCode == id).ToList();
            return lst;
        }
        ...
        [HttpGet]
        [Route("DeleteProjectDetailData/{id}")]
            ...
            using (EmployeeEntities ent = new EmployeeEntities())
            {
                ...
                var result = (from p in ent.Projct_Details
                              ...
                              select new
                              {
                                  ...
                                  States = empg.Key.States_UT,
                                  NumberofProject = empg.Select(x => x.p.ProjectCode).Distinct().Count(),
        ...
        [HttpGet]
        [Route("GetStateDistrictWiseReport/{id}")]
        ...
        [HttpGet]
        [Route("GetStateDistrictCityProjectWiseReport/{id}")]
        ...
        [HttpPost]
        //post api for submit slum
        [Route("SubmitSlum")]
        public HttpResponseMessage SubmitSlum(List<Project_Code_Slum> obj)
        {
            using (EmployeeEntities ent = new EmployeeEntities())
            {

                foreach (Project_Code_Slum Slum in obj)
                {

                    ent.Project_Code_Slum.Add(Slum);
                    ent.SaveChanges();
        ...
        [Route("ExcelUploadProjectDetailData")]
        ...
        [HttpGet]
        [Route("DeleteStateClassificationMapping/{id}")]
        ...
        [HttpGet]
        [Route("DeleteDistrictClassificationMapping/{id}")]
        ...
        [HttpGet]
        [Route("DeleteCityClassificationMapping/{id}")]
        ...
        [HttpGet]
        [Route("DeleteProjectClassificationMapping/{id}")]
